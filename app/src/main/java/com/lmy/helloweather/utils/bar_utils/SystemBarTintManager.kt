...
class SystemBarTintManager @SuppressLint("ResourceType") @TargetApi(19) constructor(activity: Activity) {
        ...
        init {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                sNavBarOverride = try {
                    ...
                    val method = aClass.getDeclaredMethod("get", String::class.java)
                    method.setAccessible(true)
                    method.invoke(null, "qemu.hw.mainkeys").toString()
                } catch (e: Throwable) {
                    null
                }
            }
    ...
    class SystemBarConfig(
        ...
        companion object {
            ...
            private const val NAV_BAR_HEIGHT_LANDSCAPE_RES_NAME =
        ...
        init {
            ...
            mInPortrait =
                res.configuration.orientation == Configuration.ORIENTATION_PORTRAIT
